---
title: "$publish / /publish: Save Final Content and Get Publishing Guidance"
sidebarTitle: "publish"
description: "Dispatch the admin agent to save approved content to the published folder, generate a platform-specific publishing checklist, and capture metadata for performance tracking."
---
