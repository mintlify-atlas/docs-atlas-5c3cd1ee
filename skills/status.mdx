...
sidebarTitle: "status"
description: "Display a snapshot of active personas, interview coverage, and content pipeline stage counts — grounded strictly in files that are present on disk."
---
