---
title: "Polysona REST API Overview: Local Dashboard Endpoints"
sidebarTitle: "Overview"
description: "Complete reference for Polysona's local REST API: persona data, content pipeline, agent status, and QA simulation — all served on localhost:3000."
---
