---
title: "Run the Polysona Local Dashboard: Setup and API Reference"
sidebarTitle: "Dashboard"
description: "Launch the Hono and React dashboard with bun run dev to visualize personas, monitor agent status, and inspect the content pipeline locally."
---
