---
title: "Polysona Claude Code Plugin Setup and Command Reference"
sidebarTitle: "Claude Code"
description: "Install the Polysona plugin via the local marketplace and use slash commands to run your persona pipeline from any Claude Code session."
---
