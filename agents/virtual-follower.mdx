...
The total score for each draft per archetype is the sum of all five dimension scores. Archetypes are ranked by total score descending. The TOP 5 are the five archetypes with the highest totals.
